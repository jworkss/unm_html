	...
	class Details {
		constructor() {
			...
			<div class="details__bg details__bg--down">
				<button class="details__close"><i class="fas fa-2x fa-times icon--cross unm-fa-close"></i></button>
			...
			document.getElementById('unm-wrap').appendChild(this.DOM.details);
			this.init();
		}
		init() {
        ...
        setCarousel() {
	        ...
	        var slider = $('.details .unm-img-slider');
